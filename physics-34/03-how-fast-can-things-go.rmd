...
the $x$ axis is dilated by a factor of $\frac{1}{10^{8}}$ so we can see the effect

### proper time

proper time is the time between two events happening at the same location
...
proper length is the length of an object as measure by an observer who is stationary relative to that object
...
muons are tiny particles that are produced when cosmic rays enter the earth's atmosphere

### rest energy

rest energy is the energy equivalent to the mass of a particle at rest in an inertial frame of reference

$$E_0=mc^2$$

### total energy

$$E_\text{total}=E_0+E_k$$
$$E_\text{total}=\gamma{}mc^2=\frac{mc^2}{\sqrt{1-(\frac{v}{c})^2}}$$

### kinetic energy (relativistic effect)

$$E_k=(\gamma{}-1)mc^2$$
$$E_k=(\frac{1}{\sqrt{1-(\frac{v}{c})^2}}-1)mc^2$$